...
# PARSE ARGUMENTS
# ------------------------
parser = argparse.ArgumentParser(description="Live metrics plotter")
# parser.add_argument("--file", type=str, default="cartpoleMetric.csv", help="Path to the metrics CSV file")
parser.add_argument("--file", type=str, default="mountaincarMetric.csv", help="Path to the metrics CSV file")
...
fig.suptitle("Live Training Metrics", fontsize=14)
